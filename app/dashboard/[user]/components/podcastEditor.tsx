...
import { Podcasts } from "@/types/general";
...
export default function PodcastEditor({ data, articles }: { data: { rubrique: { ID: string, name: string, slug: string }[] }, articles: Podcasts }) {
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button onClick={async () => {
                            ...
                            const articleData = {
                                ...
                                audioID: articles.audioID,
                                podcastID: articles.articleID,
